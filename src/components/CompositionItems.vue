...
export default {
  ...
  data() {
    return {
      ...
      alert_message: 'Please wait. Updating song details.',
    };
  },
  methods: {
    async edit(values) {
      ...
      this.alert_message = 'Please wait. Updating song details.';
      ...
      try {
        ...
        this.alert_message = 'Something went wrong. Tra again later.';
        return;
      }
